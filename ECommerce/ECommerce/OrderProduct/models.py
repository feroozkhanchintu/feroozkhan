...
class Orders(models.Model):
    ...
    user = models.ForeignKey('User', models.DO_NOTHING, db_column='User_ID', null=True)  # Field name made lowercase.
    amount = models.FloatField(db_column='Amount', blank=True, null=True)  # Field name made lowercase.
    deleted = models.BooleanField(db_column='Deleted', blank=True, default=False)  # Field name made lowercase. This field type is a guess.
...
class Product(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    product_id = models.CharField(db_column='Product_ID', max_length=25)  # Field name made lowercase.
    name = models.CharField(db_column='Name', max_length=45, blank=True, null=True)  # Field name made lowercase.
    ...
    isavailable = models.BooleanField(db_column='isAvailable', blank=True, default=True)  # Field name made lowercase. This field type is a guess.
    category = models.ForeignKey(Category, models.DO_NOTHING, blank=True, null=True)

    def __unicode__(self):
        return self.product_id or u''
